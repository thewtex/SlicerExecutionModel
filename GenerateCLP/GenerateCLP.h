...
//  /home/matt/apps/slicer_execution_model_rdb/GenerateCLP/bin/GenerateCLP --InputXML GenerateCLP/GenerateCLP.xml --OutputCxx GenerateCLP/GenerateCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    </boolean>\n"
"    <boolean>\n"
"      <name>UseSerializer</name>\n"
"      <longflag>--UseSerializer</longflag>\n"
"      <label>Add serializer flags.</label>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    msg.str("");msg << " (default: " << UseSerializer << ")"; \
    TCLAP::SwitchArg UseSerializerArg("", "UseSerializer", msg.str(), commandLine, UseSerializer); \
 \
...
#define GENERATE_TCLAP_ASSIGNMENT \
      ...
      UseSerializer = UseSerializerArg.getValue(); \
...
std::cout << "    UseSerializer: " << UseSerializer << std::endl; \
for (unsigned int _i= 0; _i < logoFilesTemp.size(); _i++) \
{ \
